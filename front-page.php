<?php get_header(); ?>
      ...
      <div class="jumbotron">
        <div class="container">
          ...
          <p class="lead"><?php echo get_theme_mod('banner_text', 'Vivamus rutrum dui at lorem ultrices, eget tincidunt nisl tincidunt. Sed feugiat arcu at interdum lacinia.'); ?></p>
        ...
        <div class="container">
          <div class="col-lg-4">
            <div class="block">
              ...
              <p><?php echo get_theme_mod('box1_text', 'onec id elit non mi porta gravida at eget metus. Maecenas faucibus mollis interdum.'); ?></p>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="block">
              ...
              <p><?php echo get_theme_mod('box2_text', 'onec id elit non mi porta gravida at eget metus. Maecenas faucibus mollis interdum.'); ?></p>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="block">
              ...
              <p><?php echo get_theme_mod('box3_text', 'onec id elit non mi porta gravida at eget metus. Maecenas faucibus mollis interdum.'); ?></p>
            </div>
          </div>
        </div>
      </section>
